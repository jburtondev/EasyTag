...
/*	
	...
	*/
      ...
      if (typeof element === 'undefined') {
         ...
         var p_export = document.getElementById("p_tag_export").innerHTML = p_export = "<" + document.getElementById("selectTag0").value + ">" + p.value + "</" + document.getElementById("selectTag0").value + ">";
